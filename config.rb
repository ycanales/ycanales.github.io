...
set :blog_name, 'ycanales'
set :blog_description, 'Anotaciones esporádicas.'
set :author_name, 'Cristian Yáñez C.'
set :author_bio, 'Irremediablemente esporádico. Desarrollador web.'
# Optional
